...
import pprint
from calculators.miningCostModels import room_and_pillar_shaft_entry
...
class roomAndPillarMethod:
    def __init__(self):
        ...
        self.ex_output_args = (self.required_output * self.operating_per_week * self.mine.conversion_efficiency * self.mining_packages) / 7
        ...
        self.opex_df, self.capex_df = room_and_pillar_shaft_entry(self.ex_output_args,
    ...
    def __repr__(self):
        ...
        total_opex = self.opex_df['total opex'].loc['room and pillar method']
