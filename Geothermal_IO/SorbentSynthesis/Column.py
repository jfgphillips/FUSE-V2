...
class Column_att(object):
    def __init__(self):
        ...
        self.brine_flow_rate = self.bed_volume * self.['value'].loc['brine_flow_rate']
        self.washing_flow_rate = self.bed_volume * self.['value'].loc['washing_flow_rate']
        self.stripping_flow_rate = self.bed_volume * self.['value'].loc['stripping_flow_rate']
        return
